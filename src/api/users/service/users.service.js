...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepo.findByEmail(payload.email)];
                    case 1:
                        getUser = _a.sent();
                        if (getUser)
                            throw new common_1.HttpException('User Already Exists', 400);
                        return [4 /*yield*/, this.userRepo.create(payload)];
    ...
    UserService = __decorate([
        ...
        __param(0, (0, common_1.Inject)(users_repository_1.UserRepository))
    ], UserService);
    return UserService;
}());
